...
namespace HTNColors
{
	const FLinearColor Asset(0.715f, 0.24f, 0.055f);
	...
	namespace NodeBorder
	{
		...
		const FLinearColor SearchHighlight(0.08f, 1.0f, 0.08f);
		const FLinearColor SearchHighlightSelected(1.00f, 1.00f, 0.08f);
	}
